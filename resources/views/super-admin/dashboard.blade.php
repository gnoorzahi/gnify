...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="flow-root">
                <ul class="-my-5 divide-y divide-gray-200">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 truncate">
                                        {{ $tenant->primaryDomain?->getFullDomain() ?? 'No domain set' }}
                                    </p>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $tenant->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    @empty
                        <li class="py-4 text-center text-gray-500">No tenants yet</li>
                    @endforelse
                </ul>
            </div>
            <div class="mt-6">
                <a href="{{ route('super-admin.tenants.index') }}" class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    View all tenants
                </a>
            </div>
        </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Recent Domains</h3>
            <div class="flow-root">
                <ul class="-my-5 divide-y divide-gray-200">
                    @forelse($recent_domains as $domain)
                        <li class="py-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-shrink-0">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $domain->isVerified() ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                    ...
                    @empty
                        <li class="py-4 text-center text-gray-500">No domains yet</li>
                    @endforelse
                </ul>
            </div>
            <div class="mt-6">
                <a href="{{ route('super-admin.domains.index') }}" class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    View all domains
                </a>
            </div>
        </div>
